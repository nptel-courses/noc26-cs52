    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.querySelectorAll(".check-btn").forEach((btn) => {
            btn.addEventListener("click", function () {
                ...
                // Toggle solution area visibility: show only when user clicks
                if (solutionDiv) {
                    const wasVisible = solutionDiv.classList.contains("show");
                    // hide all other solution areas
                    document.querySelectorAll(".solution-area").forEach((div) => div.classList.remove("show"));
                    if (!wasVisible) {
